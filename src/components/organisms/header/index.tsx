...
const Header = ({ hideNavigation = false }) => {
  return (
    <div className="sticky w-full top-0 z-50 bg-black/50 backdrop-blur-xl border-b border-white/10">
      <header className="h-20 mx-4 lg:mx-24 flex justify-between items-center text-white">
        ...
        <div className="w-44 flex justify-end">
          <Link
            href="/contact"
            className="shadow-md bg-black border border-white/20 flex flex-row items-center text-sm text-white font-medium px-4 py-2 rounded-full"
          >
            Book Now &nbsp; <PhoneArrowUpRight />
          </Link>
        </div>
      </header>
    </div>
