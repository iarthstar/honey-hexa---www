  ...
  return (
    <div className="bg-gradient-to-b from-black via-blue-800 to-blue-300 border-0 rounded-b-[4rem] overflow-hidden">
      <PageContainer className="flex flex-col justify-center items-center h-96 mt-32 mb-24">
        <Text as="h1" size="8xl" className="text-white font-black text-center uppercase tracking-tighter drop-shadow-lg">OOPS<br /><span className="text-blue-300">PAGE NOT FOUND</span></Text>
        <Text as="p" size="base" className="text-white text-center mt-4 max-w-2xl drop-shadow-md">The page you are looking for couldn&apos;t be found</Text>
        <div className="mt-12">
        ...
        <Marquee items={marqueeItems} view={() => <div className="text-white uppercase text-4xl font-black tracking-tighter px-24 py-12">404</div>} />
    </div>
  )
}
